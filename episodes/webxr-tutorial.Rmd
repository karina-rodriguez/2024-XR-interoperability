...
This tutorial will allow you to implement
a basic interoperable 3D environments 
on a web interface by using WebGL. 
...
Using https://brighton.domains/ create a folder on a subdomain,
such as vrtest.yourname.brighton.domains. Through this, you will be able to test your own VR example, such as mine: https://vrtest.kre.brighton.domains
