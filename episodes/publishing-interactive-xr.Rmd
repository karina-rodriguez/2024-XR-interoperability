...
To see some of this examples,
you will need to install [Mozilla XR Viewer](https://labs.mozilla.org/projects/webxr-viewer/)


## Mozilla Hubs

This is a VR platform over the web, it is collaborative
and allows to create your own content.

See webpage at: [https://hubs.mozilla.com/](https://hubs.mozilla.com/)
...
Allows to easily display interactive 3D models on the web & in AR.
